# Devcation Delhi 2026 — Hack 'N' Solve

[![Event](https://img.shields.io/badge/Event-Devcation_Delhi_2026-amber)](https://github.com/MDMOINAKHTARR/Devcation)
[![Organizers](https://img.shields.io/badge/Organized_by-GDG_IGDTUW_×_GDG_IIT_Delhi-black)](https://github.com/MDMOINAKHTARR/Devcation)
[![Prize Pool](https://img.shields.io/badge/Prize_Pool-₹1.5L-e8870a)](https://github.com/MDMOINAKHTARR/Devcation)

A premium, ground-up redesign of the Devcation hackathon landing page, featuring a distinctive **Editorial-Brutalist** visual identity. Built with **Next.js 15**, **Matter.js**, and **Tailwind CSS**, this platform moves beyond static information to create an interactive, spatial brand experience.
...
- **Design Tokens**: Strict editorial grid system without rounded corners or soft shadows.
...
## 📐 Design Philosophy
The design principle is **"Answers over Information."** Every section is engineered to answer the participant's next question: *"What do I do next?"* or *"Am I eligible?"*. This project demonstrates advanced prompt engineering and bespoke front-end orchestration to create a "Designed, not Generated" feel.
